...
const Step2 = ({
  ...
  const selectedOption = DESTINATION_OPTIONS.find(
    (option) => option.value === preferences.destination
  ...
  return (
    <>
      <SimpleToast
        title="Please choose a destination type"
        description="Abroad or Local?"
        buttonText="Close"
...
Step2.propTypes = {
  ...
  DESTINATION_OPTIONS: PropTypes.array.isRequired,
